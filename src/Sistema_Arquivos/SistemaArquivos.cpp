...
void SistemaArquivos::set_n(int n){
	this->n = n;
}
void SistemaArquivos::adiciona_arquivo_gravado(char* informacao_arquivo){
...
void SistemaArquivos::adiciona_operacao_arquivo(char* informacao_operacao){
...
int SistemaArquivos::get_total_blocos_disco(){
	return this->total_blocos_disco;
}
int SistemaArquivos::get_n(){
	return this->n;
}
...
void SistemaArquivos::executa_operacoes_sobre_arquivo(std::vector<Processo> lista_processos){
...
void SistemaArquivos::tenta_deletar_arquivo(std::vector<Processo> lista_processos){
...
bool SistemaArquivos::processo_criou_arquivo(int pid_processo, char nome_arq){
...
void SistemaArquivos::salva_processo_criador_do_arquivo(operacao_arquivo operacao_para_criar, int bloco_inicial){
...
void SistemaArquivos::imprime_mensagem_sucesso_criacao_arquivo(operacao_arquivo operacao_para_criar, int posicao_inicial_para_gravar_arquivo){
	printf("Sucesso\n");
...
bool SistemaArquivos::existe_arquivo_gravado_com_mesmo_nome(char nome){
	int bloco;
...
void SistemaArquivos::imprime_informacoes_disco(){
